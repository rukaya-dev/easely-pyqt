...
class AppointmentStore(QObject):
    ...
    def __init__(self):
        ...
        self.active_appointment_tab = "all"
        self.fallback_active_appointment_tab = "all"
        self.all_tab_data = {}
        self.scheduled_data = {}
    ...
    def get_active_appointment_tab(self):
        return self.active_appointment_tab

    def get_fallback_active_appointment_tab(self):
        return self.fallback_active_appointment_tab

    def set_active_appointment_tab(self, tab):
        if tab != "search_filter":
            self.fallback_active_appointment_tab = tab
        self.active_appointment_tab = tab
        self.signals.globalAppointmentStateManagementTabSignal.emit(tab)
