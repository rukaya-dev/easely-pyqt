...
from views.componenets.textEditorComponenets.options.template_options_list_widget import TemplateOptionsListWidget
from views.componenets.textEditorComponenets.zeusEditor.zeus_editor import ZeusTextBox


class MainTemplateEditorView(QWidget):
    def __init__(self, view_type, data, parent=None):
        ...
        self.options_widget = TemplateOptionsListWidget(self.category)
        self.options_widget.optionChecked.connect(self.add_option_to_editor)
        ...
        central_layout.addWidget(self.zeus_editor_text_box)
        ...
        self.disabling_editor_widgets()

    def disabling_editor_widgets(self):
        if self.view_type == "view_template":
            self.format_bar.setDisabled(True)
    ...
    def remove_option_from_editor(self, option_name):
        ...
        # print("current editorViews font size", self.zeus_editor_text_box.currentCharFormat().fontPointSize())
