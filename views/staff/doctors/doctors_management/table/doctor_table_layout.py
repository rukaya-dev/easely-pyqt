...
from views.staff.doctors.doctors_management.table.doctor_context_menu import DoctorContextMenu

logger = set_up_logger('main.views.staff.doctors.table.table_layout')


class DoctorTableLayout(QWidget):
    viewSignal = pyqtSignal()
    editSignal = pyqtSignal()
    deleteSignal = pyqtSignal()
    serviceManagementSignal = pyqtSignal()
    ...
    def __init__(self, data_controller, data_columns=None, column_display_names=None, is_pagination=True,
        ...
        self.table_model = TableModel(table_name="doctors", data_columns=data_columns, column_display_names=column_display_names)
    ...
    def show_context_menu(self, position):
        if position is not None:
            ...
            self.contextMenu = DoctorContextMenu()
    ...
    def menu_item_triggered(self, item_id, current_row_index):
        ...
        elif item_id == "service_management":
            self.serviceManagementSignal.emit()
