...
class FilterWidget(QWidget):
    ...
    async def clear_filter(self):
        self.signals.globalCreateLoadingNotificationSignal.emit("CLEAR_REFERRING_DOCTOR_FILTER")
        ...
        self.referring_doctor_controller.store.set_filter_preferences({})
        self.parent.refresh_table()
        self.signals.globalLoadingNotificationControllerSignal.emit("CLEAR_REFERRING_DOCTOR_FILTER")
        self.close_menu()

    @pyqtSlot()
    @asyncSlot()
    async def apply_filter(self):
        self.signals.globalCreateLoadingNotificationSignal.emit("APPLY_REFERRING_DOCTOR_FILTER")
        ...
        self.referring_doctor_controller.store.set_filter_preferences(preferences)
        self.parent.refresh_table()
        self.signals.globalLoadingNotificationControllerSignal.emit("APPLY_REFERRING_DOCTOR_FILTER")
        self.close_menu()
