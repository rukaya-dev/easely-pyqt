...
from views.activity_center.logs.table.context_menu import LogsContextMenu

logger = set_up_logger('views.activity_center.logs.table.table_layout')


class LogsTableLayout(QWidget):
    ...
    def __init__(self, data_controller, data_columns=None, column_display_names=None, is_pagination=True,
        ...
        self.table_model = TableModel(table_name="log_audit",data_columns=data_columns, column_display_names=column_display_names)
    ...
    def show_context_menu(self, position):
        if position is not None:
            ...
            self.contextMenu = LogsContextMenu()
