...
class NextPaginationButton(QPushButton):
    def __init__(self,  parent=None):
        ...
        self.next_icon = QIcon(":resources/icons/pagination_arrow_forward.svg")
    ...
    def stop(self):
        if hasattr(self, "_movie"):
            self.setIcon(QIcon(":resources/icons/pagination_arrow_forward.svg"))
            self._movie.stop()
