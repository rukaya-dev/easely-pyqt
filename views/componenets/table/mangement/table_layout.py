...
from views.componenets.table.mangement.custom_context_menu import CustomContextMenu
...
logger = set_up_logger('views.components.table.management.table_layout')
...
class TableLayout(QWidget):
    ...
    def show_context_menu(self, position):
        if position is not None:
            ...
            self.contextMenu = CustomContextMenu()
