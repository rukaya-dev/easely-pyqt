...
logger = set_up_logger('main.views.settings.services.service_filter_widget')
...
class FilterWidget(QWidget):
    ...
    async def clear_filter(self):
        ...
        self.service_controller.store.set_filter_preferences({})
    ...
    async def apply_filter(self):
        ...
        # try:
        self.service_controller.store.set_filter_preferences(preferences)
        self.parent.refresh_table()
